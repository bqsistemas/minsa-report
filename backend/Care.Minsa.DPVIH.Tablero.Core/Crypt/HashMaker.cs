...
namespace Care.Minsa.DPVIH.Tablero.Core.Crypt
{
    /* 
     * Source https://programs.faltutech.com/2019/03/01/hash-a-password-and-verify-password-using-c-net-core-dot-net-core/
     */
