...
@Component({
  selector: 'vex-resolve-question-cuadro-comentario',
  templateUrl: './resolve-question-cuadro-comentario.component.html',
  styleUrls: ['./resolve-question-cuadro-comentario.component.scss']
})
export class ResolveQuestionCuadroComentarioComponent implements OnInit {
