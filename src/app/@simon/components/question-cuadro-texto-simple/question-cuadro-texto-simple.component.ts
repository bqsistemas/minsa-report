...
@Component({
  selector: 'vex-question-cuadro-texto-simple',
  templateUrl: './question-cuadro-texto-simple.component.html',
  styleUrls: ['./question-cuadro-texto-simple.component.scss'],
  animations: [
    stagger60ms,
    fadeInUp400ms
  ]
})
export class QuestionCuadroTextoSimpleComponent implements OnInit {
  ...
  fnCreateOptionFormGroup(option: Option): FormGroup {
    return new FormGroup({
      ...
      score: new FormControl(option.score, [Validators.pattern('^[0-9]*$')]),
