...
@Component({
  selector: 'vex-question-cuadro-comentario',
  templateUrl: './question-cuadro-comentario.component.html',
  styleUrls: ['./question-cuadro-comentario.component.scss'],
  animations: [
    stagger60ms,
    fadeInUp400ms
  ]
})
export class QuestionCuadroComentarioComponent implements OnInit {
