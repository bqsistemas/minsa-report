...
@Component({
  selector: 'vex-question-casilla-verificacion',
  templateUrl: './question-casilla-verificacion.component.html',
  styleUrls: ['./question-casilla-verificacion.component.scss'],
  animations: [
    stagger60ms,
    fadeInUp400ms
  ]
})
export class QuestionCasillaVerificacionComponent implements OnInit {
