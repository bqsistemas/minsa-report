...
@Component({
  selector: 'vex-widgets-charts-instrumentos-plan-muestras-local',
  templateUrl: './widgets-charts-instrumentos-plan-muestras-local.component.html',
  styleUrls: ['./widgets-charts-instrumentos-plan-muestras-local.component.scss'],
  animations: [scaleInOutAnimation]
})
export class WidgetsChartsInstrumentosPlanMuestrasLocalComponent implements OnInit, AfterViewInit {
  ...
  fnSearch(instrumento: string = null) {
    ...
    this._muestraService.postResumenAsignacionMuestraUgel(this.idPlanMonitoreo.value, instrumento,
